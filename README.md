...
- `action`: `LOGIN`, `LOGIN_FAILED`, `LOGOUT`, `UPLOAD`, `VIEW`, `DOWNLOAD`, `ACCESS_DENIED`, `ACCESS_GRANTED`, `ACCESS_REVOKED`, `DOWNLOAD_PERMISSION_CHANGED`, `AUDIT_LOG_EXPORTED`, `DRIVE_MIGRATION`, `PRINT_ATTEMPT`, `USER_CREATED`, `USER_UPDATED`, `USER_DELETED`, `PASSWORD_RESET`, `DOCUMENT_DELETED`, `DOCUMENT_UPDATED`, `PASSWORD_CHANGED`, `PASSWORD_CHANGE_FAILED`
